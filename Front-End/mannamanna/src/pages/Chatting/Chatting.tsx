...
import {ChatPeopleBox, LeftChatBox, RightChatBox, ChatProFile, ChatContainerBox, ChatLeftStyle, ChatRightStyle, ChatInBox, ChatPeopleOutBox, ChatOutBox, ChatInputBox} from './ChattingStyle';
                ...
                <ChatContainerBox>
                    ...
                    <MacBookBox width="60%" height="90%" color1="#ffcced" color2="#ffffff" alignItems='center'>
                        ...
                        <ChatInputBox>
                            ...
                            sx={{ width: '70%', backgroundColor: '#ffcced', borderRadius:'0.5vw' }}
                            />
                            <Button variant="contained" sx={{ backgroundColor: '#ffcced'}} onClick={handleSubmit}>
                                {/* 보내기 */}
                                <SendIcon />
                            </Button>
                        </ChatInputBox>
