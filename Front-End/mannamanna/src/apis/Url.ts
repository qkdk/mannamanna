...
export const WS_BASE_URL =
  (DEV ? `ws://localhost${PORT_SERVER}` : "wss://i7a309.p.ssafy.io") +
  "/ws/ava";
export const API_BASE_URL = "https://i9b205.p.ssafy.io/api";
export const API_LOGIN_URL = "http://i9b205.p.ssafy.io:9999"; // 로그인은 api 생략임
export const OPENVIDU_SERVER_URL = 'https://i9b205.p.ssafy.io:8443/';
...
export const SOCET_URL="wss://i9b205.p.ssafy.io/ws";