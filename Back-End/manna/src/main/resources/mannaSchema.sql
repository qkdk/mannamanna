...
CREATE TABLE IF NOT EXISTS `manna`.`member_address` (
  ...
  CONSTRAINT `FKjs27hhsb2c82bwrn8kj3ji3qu`
    FOREIGN KEY (`id`)
    REFERENCES `manna`.`address` (`id`))
ENGINE = InnoDB
AUTO_INCREMENT = 4
...
CREATE TABLE IF NOT EXISTS `manna`.`mission` (
  ...
  `male_image_name` VARCHAR(255) NULL DEFAULT NULL,
  `female_image_path` VARCHAR(255) NULL DEFAULT NULL,
  `female_image_name` VARCHAR(255) NULL DEFAULT NULL,
  `star_date` DATETIME NOT NULL,
  `end_date` DATETIME NOT NULL,
  `start_date` DATETIME(6) NULL DEFAULT NULL,
  `female_id` VARCHAR(255) NULL DEFAULT NULL,
  `is_success` BIT(1) NULL DEFAULT NULL,
  `male_image_mame` VARCHAR(255) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `manna`.`note` (
  ...
  `contennt` VARCHAR(255) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `manna`.`schedule` (
  ...
  CONSTRAINT `fk_schedule_opponent_id`
    FOREIGN KEY (`opponent_id`)
    REFERENCES `manna`.`member` (`id`),
  CONSTRAINT `FKq6t95q4xrmr7ijgan5dftdsn8`
